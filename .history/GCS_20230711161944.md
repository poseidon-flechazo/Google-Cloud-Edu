...
gcloud storage cp test gs://-test/
```
結果：
```
Copying file://test to gs://-test/test
  Completed files 1/1 | 32.0B/32.0B
```
3. 確認
```bash
gcloud storage cp gs://-test/test#1688432431213768 ./
...
Created [https://sqladmin.googleapis.com/sql/v1beta4/projects//instances/postgresql15].
...
```bash
cloud_sql_proxy -instances=:asia-northeast1:postgresql15=tcp:5432
```
結果：
```
2023/07/04 15:54:31 Rlimits for file descriptors set to {Current = 8500, Max = 9223372036854775807}
2023/07/04 15:54:36 Listening on 127.0.0.1:5432 for :asia-northeast1:postgresql15
...
```
2023/07/04 17:21:42 New connection for ":asia-northeast1:postgresql15"
2023/07/04 17:21:42 refreshing ephemeral certificate for instance :asia-northeast1:postgresql15
2023/07/04 17:21:45 Scheduling refresh of ephemeral certificate in 54m58.522266s
2023/07/04 17:21:45 New connection for ":asia-northeast1:postgresql15"
