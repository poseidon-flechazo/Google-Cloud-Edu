...
結果：
```
Created [https://www.googleapis.com/compute/v1/projects//global/healthChecks/nginx-health-check1].
NAME                 PROTOCOL
...
結果：
```
Created [https://www.googleapis.com/compute/v1/projects//global/backendServices/nginx-backend-service].
...
結果：
```
Updated [https://www.googleapis.com/compute/v1/projects//global/backendServices/nginx-backend-service].
```
4. 一旦確認
```bash
...
- balancingMode: UTILIZATION
  capacityScaler: 1.0
  group: https://www.googleapis.com/compute/v1/projects//zones/asia-northeast1-b/instanceGroups/nginx-group
connectionDraining:
...
healthChecks:
- https://www.googleapis.com/compute/v1/projects//global/healthChecks/nginx-health-check1
...
portName: http
protocol: HTTP
selfLink: https://www.googleapis.com/compute/v1/projects//global/backendServices/nginx-backend-service
...
結果：
```
Created [https://www.googleapis.com/compute/v1/projects//global/urlMaps/nginx-url-map].
...
結果：
```
Created [https://www.googleapis.com/compute/v1/projects//global/targetHttpProxies/nginx-target-proxy].
NAME                URL_MAP
...
結果：
```
Created [https://www.googleapis.com/compute/v1/projects//global/forwardingRules/nginx-forwarding-rule].
```
- 付与されたIPアドレスを確認
```bash
...
結果：
```
Created [https://www.googleapis.com/compute/v1/projects//global/securityPolicies/nginx-security-policy].
```
...
結果：
```
Updated [https://www.googleapis.com/compute/v1/projects//global/securityPolicies/nginx-security-policy].
```
2. 一旦確認
```bash
gcloud compute security-policies rules describe 2147483647 --security-policy=nginx-security-policy
